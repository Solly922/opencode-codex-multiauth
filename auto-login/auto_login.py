#!/usr/bin/env python3
"""
Auto-login for codex-multiauth.
...
# ── Constants (matching codex-multiauth plugin exactly) ─────────────────────
...
STORE_FILE = STORE_DIR / "codex-multiauth-accounts.json"
...
# ── Main ────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="Auto-login for codex-multiauth")
