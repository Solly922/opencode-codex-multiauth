...
Then point OpenCode at the built plugin entry in `dist/index.js`.
...
```bash
codex-multiauth add acc1
codex-multiauth add acc2
codex-multiauth status
```

Account store file:

- `~/.config/opencode/codex-multiauth-accounts.json`
...
- `... codex-multiauth ... loading plugin`
