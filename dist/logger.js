...
const DEFAULT_LOG_DIR = path.join(os.homedir(), '.config', 'opencode', 'codex-multiauth', 'logs');
const LOG_FILE = process.env.CODEX_MULTIAUTH_LOG_PATH ||
    process.env.CODEX_SOFT_LOG_PATH ||
    path.join(DEFAULT_LOG_DIR, 'codex-multiauth.log');
